...
@Getter // Getter 생성
@Setter // Setter 생성
public class RecipeQuestionDTO {
	/**
	 * 
	 */
	...
	public RecipeQuestionDTO(Object idx, Object q_id, Object u_id, Object r_id, Object question, Object answer) throws ParseException {
		if (idx != null)
	...
	public RecipeQuestionDTO(HashMap<String, Object> map) {
		if (map.get("idx") != null)
